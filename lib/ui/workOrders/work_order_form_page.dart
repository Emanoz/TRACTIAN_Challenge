          ...
          children: [
            ...
            CustomOptionsButton(
              ...
              onTap: () => showItemsOptions(
                context,
                label: 'Assets',
                itemBuilder: (_, index) => const ItemView('M14 Mill Shaft Motor', AssetsStatus.inProgress,
                    'resources/icons/exampleImage.svg', 'Injection/Painting'),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(bottom: 8.0, top: 26.0),
            ...
            CustomOptionsButton(
              ...
              onTap: () => showItemsOptions(
                context,
                label: 'Users',
                itemBuilder: (_, index) => const ItemView('John Doe', null, null, 'emanuel@hotmail.com'),
              ),
            ),
            Padding(
